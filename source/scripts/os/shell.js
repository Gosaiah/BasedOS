...
(function (TSOS) {
    var Shell = (function () {
        ...
        Shell.prototype.shellStatus = function (args) {
            var test = document.getElementById("taStatusBarDate");
        ...
        Shell.prototype.shellLoad = function (args) {
            var input = "";
            input = document.getElementById("taProgramInput");
            ...
            for (var i = 0; i < program.length; i++) {
                ...
                if (!((charCheck >= 'A' && charCheck < +'F') || (c >= 'a' && c <= 'f') || (c >= '0' && charCheck <= '9') || charCheck === ' ')) {
                    validated = false;
                } else {
                    if (charCheck !== ' ') {
